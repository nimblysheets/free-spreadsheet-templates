# Free Excel spreadsheet templates — Nimbly Sheets
...
1. Download the workbook that matches your language and currency display.
2. Open it in Excel, or upload the `.xlsx` file to Google Drive and choose **Open with Google Sheets**.
3. Read the first instruction tab.
4. Replace the fictional example rows and review the editable categories and assumptions.
5. Check formulas and outputs against your own source records before relying on them.

The EUR, USD, MXN and BRL labels describe visible number formats. The files do not convert currencies, retrieve exchange rates, connect to accounts or platforms, or verify external information.

## Full editions and bundles

- [Spanish catalogue](https://nimblysheets.com/es?utm_source=github&utm_medium=repository&utm_campaign=free_templates)
- [English catalogue](https://nimblysheets.com/en?utm_source=github&utm_medium=repository&utm_campaign=free_templates)
...
These workbooks organize information entered by the user and apply visible arithmetic. They do not provide tax, legal, accounting, financial, regulatory, commercial or other professional advice; determine obligations, compliance, suitability, benefit or future results; or replace source records or professional review.

Support: [nimblysheets@proton.me](mailto:nimblysheets@proton.me)  
Website: [nimblysheets.com](https://nimblysheets.com)

Use of the files is governed by [LICENSE.md](LICENSE.md).
